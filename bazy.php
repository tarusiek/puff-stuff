...
<html>
    ...
    <div class="left_product">
            ...
            <?php
                $query = "SELECT DISTINCT PRODUCENT FROM produkty WHERE typ_p = 3";
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo '<form method="post" action="bazy.php">';
        ...
        <div class="right_product">
            ...
            <div class="container_products_page">
                ...
                <?php
                    ...
                    $products = mysqli_query($conn, "select * from produkty where typ_p = 3");
                    ...
                    if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["producent"])) {
                        ...
                        // Wykonaj zapytanie do bazy danych, aby pobrać produkty wybranego producenta
                        $query = "SELECT * FROM produkty WHERE producent = ? AND typ_p=3";
                        $stmt = $conn->prepare($query);
                        $stmt->bind_param("s", $selectedProducent);
                        $stmt->execute();
                        $result = $stmt->get_result();
                    ...
                    $query = "SELECT * FROM produkty WHERE typ_p = 3";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<input type="hidden" name="typ_p" value="3">';
                ...
                <div class="pagination">
                    <?php
                        if (isset($_POST["producent"])) {
                            $selectedProducent = $_POST["producent"];
                            $query = "SELECT COUNT(*) FROM produkty WHERE producent = ? AND typ_p=3";
                            $stmt = $conn->prepare($query);
                            $stmt->bind_param("s", $selectedProducent);
                            $stmt->execute();
                            ...
                            $categoryRecordCount = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM produkty WHERE typ_p=3"));
                        }
